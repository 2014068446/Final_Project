  ...
  <header id="header" class="clear">
    ...
    <nav>
      <ul>
        ...
        <li><a href="landmarks.html">Discover Landmarks</a></li>
...
<div class="wrapper row2">
  ...
  <header id="header" class="clear"> 
   ...
   <div id="hgroup1">
      ...
      <figure><center><img src="images/boracaypic.jpg" alt="" HEIGHT="300px" WIDTH="900px" /><figcaption><b>Boracay Route<b></figcaption></figure>
     <div id="shortdesc">
    ...
    <div id="hgroup1">
      ...
      <figure><center><img src="images/caticlan.jpg" alt="" HEIGHT="300px" WIDTH="500px" /><figcaption><b>Caticlan Airpot<b></figcaption></figure>
     <div id="shortdesc">
   ...
   <br> <br><div id="hgroup1">
      ...
      <figure><center><img src="images/kalibo.jpg" alt="" HEIGHT="300px" WIDTH="500px" /><figcaption><b>Kalibo Airport<b></figcaption></figure>
     <div id="shortdesc">
	   	<ul class="a">
    ...
    <div class="imagery">
      	<div class="img">
      		<figure><center><img src="images/caticlanjetty.jpg" alt="" HEIGHT="200px" WIDTH="500px" /><figcaption><b>Caticlan Jetty<b></figcaption></figure>
      	</div>
      	<div class="img">
      		
      <figure><center><img src="images/cagbanbora.jpg" alt="" HEIGHT="200px" WIDTH="500px" /><figcaption><b>Cagban Port<b></figcaption></figure>		
      	</div>
      </div><br>
      ...
      <section id="services" class="clear">
        ...
        <div class="line-separator"></div>
	   		...
	   		<%
				...
				out.println("Arrival: "+mr.getrEturn()+"<br>");
